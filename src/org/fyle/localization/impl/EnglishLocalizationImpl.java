...
public class EnglishLocalizationImpl implements Localization{
    ...
    @Override
    public String getLRStatusLabelNotConnected(){
    	return "Not connected.";
    }
    
    @Override
    public String getLRStatusLabelConnecting() {
    	return "Connecting...";
    }

	@Override
	public String getLRStatusLabelConnectExcRefused() {
		return "Connection error: Refused.";
	}

	@Override
	public String getLRStatusLabelConnectExcTimeout() {
		return "Connection error: Timeout.";
	}
	
	@Override
	public String getLRStatusLabelConnectExcOtherIO(){
		return "Connection error: IO error.";
	}
	
	@Override
	public String getLRStatusLabelConnected(){
		return "Connected.";
	}

	@Override
	public String getSendFileButtonTooltip() {
		return "Send a file.";
	}

	@Override
	public String getSendDirButtonTooltip() {
		return "Send whole directory.";
	}
}
